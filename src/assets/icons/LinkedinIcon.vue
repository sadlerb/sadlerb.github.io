<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" width="100px"
        height="100px">
        <path
    ...
    <path
        style="fill:none;stroke:currentColor;stroke-width:1.9758;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;"
